...
public class BlockTagDataGen extends BlockTagsProvider {
    ...
    public void addTags() {
        ...
        tag(ModBlockTags.PURE_SOUL_FIRE_BASED_BLOCKS).add(BROKEN_REFINED_SOUL_METAL_BARS,
                ...
                PROFOUND_STONE.core(),
                PROFOUND_STONE.slab(),
                PROFOUND_STONE.stairs(),
                PROFOUND_STONE.wall(),
                PROFOUND_STONE_BRICKS.core(),
                PROFOUND_STONE_BRICKS.slab(),
                PROFOUND_STONE_BRICKS.stairs(),
                PROFOUND_STONE_BRICKS.wall(),
                CRACKED_PROFOUND_STONE_BRICKS.core(),
                CRACKED_PROFOUND_STONE_BRICKS.slab(),
                CRACKED_PROFOUND_STONE_BRICKS.stairs(),
                CRACKED_PROFOUND_STONE_BRICKS.wall());
