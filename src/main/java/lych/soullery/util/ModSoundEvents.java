...
public final class ModSoundEvents {
    ...
    public static final RegistryObject<SoundEvent> ENCHANTED_ARMOR_STAND_AMBIENT = register("mob.eas.ambient");
    public static final RegistryObject<SoundEvent> ENCHANTED_ARMOR_STAND_DEATH = register("mob.eas.death");
    public static final RegistryObject<SoundEvent> ENCHANTED_ARMOR_STAND_HURT = register("mob.eas.hurt");
    public static final RegistryObject<SoundEvent> ENCHANTED_ARMOR_STAND_STEP = register("mob.eas.step");
    public static final RegistryObject<SoundEvent> ENCHANTER_APPEAR = register("mob.enchanter.appear");
    public static final RegistryObject<SoundEvent> ENCHANTER_COUGH = register("mob.enchanter.cough");
    public static final RegistryObject<SoundEvent> ENCHANTER_CURSING_ITEM = register("mob.enchanter.cursing_item");
    public static final RegistryObject<SoundEvent> ENCHANTER_DEATH = register("mob.enchanter.death");
    public static final RegistryObject<SoundEvent> ENCHANTER_EMPOWER = register("mob.enchanter.empower");
    public static final RegistryObject<SoundEvent> ENCHANTER_HURT = register("mob.enchanter.hurt");
    public static final RegistryObject<SoundEvent> ENCHANTER_SUMMON = register("mob.enchanter.summon");
    public static final RegistryObject<SoundEvent> ENCHANTER_REGENERATE = register("mob.enchanter.regenerate");
    public static final RegistryObject<SoundEvent> ENCHANTER_TRANSFORM = register("mob.enchanter.transform");
    public static final RegistryObject<SoundEvent> ENCHANTER_YAWN = register("mob.enchanter.yawn");
    public static final RegistryObject<SoundEvent> ENCHANTING_WAND_USE = register("item.enchanting_wand.use");
    ...
    public static final RegistryObject<SoundEvent> ITEM_REPAIRED = register("random.item_repaired");
    public static final RegistryObject<SoundEvent> ITEM_VANISHING = register("random.item_vanishing");
